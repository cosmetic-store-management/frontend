...
const slides = [
  {
    ...
    description:
      "Khám phá các dòng mỹ phẩm chăm sóc da và làm đẹp chính hãng tại GlowUp, giúp bạn luôn rạng rỡ và tự tin mỗi ngày.",
  ...
  },
  {
    ...
    description:
      "Hàng ngàn deal sốc dành riêng cho bạn. Nhanh tay chốt đơn trước khi hết hạn!",
  ...
  },
  {
    ...
    description:
      "Bộ serum cao cấp chống lão hóa mới nhất. Được kiểm nghiệm bởi chuyên gia da liễu.",
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full container mx-auto px-4 md:px-6 flex flex-col justify-center max-w-3xl items-start z-20">
            <div
              className={`transition-all duration-1000 transform ${index === current ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight mb-4 tracking-tight drop-">
                {slide.title}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link
                  to={slide.ctaLink}
                  className="btn-hover bg-brand hover:bg-brand-dark text-white px-8 py-3.5 rounded-full font-bold transition-all transform hover:scale-105 flex items-center justify-center gap-2  shadow-brand/30"
                >
