...
export function HeroCarousel() {
  ...
  return (
    <section className="hero-section relative w-full overflow-hidden" style={{ height: "clamp(480px, 62vh, 680px)" }}>
      {/* Background slides */}
      {slides.map((s, i) => (
        <div
          key={s.id}
      ...
      <div
        ...
        style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(16px, 4vw, 64px)" }}
      >
        <div
          key={current}
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-5">
            ...
            />
            <span className="text-xs text-white/60 tracking-wide">{slide.badge}</span>
          </div>
          ...
          <p
            ...
            style={{ fontSize: "clamp(0.95rem, 1.5vw, 1.1rem)", maxWidth: "42ch" }}
          >
            {slide.description}
          </p>
        ...
        {slides.map((_, index) => (
          <button
            ...
            style={{
              ...
              height: "7px",
              background: index === current ? "white" : "rgba(255,255,255,0.35)",
            }}
          />
        ))}
      </div>
