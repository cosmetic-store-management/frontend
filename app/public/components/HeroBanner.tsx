    ...
    <section className="relative w-full h-[85vh] min-h-[600px] bg-ink overflow-hidden flex items-center">
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto">
        <div className="max-w-2xl text-white space-y-6">
          ...
          <p
            className="text-lg md:text-xl text-white/80 max-w-lg leading-relaxed animate-slide-up-fade"
            style={{ animationDelay: "100ms" }}
          >
            Trải nghiệm các dòng mỹ phẩm cao cấp chính hãng. Chăm sóc và nuôi
            dưỡng làn da từ sâu bên trong với GlowUp.
          </p>
          ...
          >
            <Button
              size="lg"
              className="btn-hover bg-brand hover:bg-brand-dark text-white h-14 px-8 text-base rounded-sm  shadow-brand/30"
              asChild
            >
              <Link to="/products">
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-14 px-8 text-base rounded-sm border-white/20 text-white hover:bg-white/10 hover:text-white bg-transparent backdrop-blur-md"
              asChild
            >
              <Link to="/products">Xem Danh Mục</Link>
            </Button>
          </div>

          {/* Stats */}
          <div
            className="grid grid-cols-3 gap-6 pt-12 border-t border-white/10 mt-12 animate-slide-up-fade"
