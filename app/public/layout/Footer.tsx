...
import { Facebook, Instagram, MapPin, Phone, Mail, Youtube, MessageCircle, Music2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              {settings.seoDescription ??
                "Tiên phong trong việc mang đến những sản phẩm làm đẹp chính hãng, an toàn và hiệu quả nhất. Đánh thức vẻ đẹp tự nhiên của phụ nữ Á Đông bằng sự thấu hiểu và tận tâm."}
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <Link
                  to="/about"
                  className="text-gray-400 hover:text-brand transition-colors inline-block hover:translate-x-1 duration-200"
                >
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Đừng bỏ lỡ các chương trình khuyến mãi siêu hấp dẫn và bí quyết
              làm đẹp từ chuyên gia.
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              {settings.tiktokUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-hover w-10 h-10 rounded-full bg-[#1a1a1a] flex items-center justify-center text-white hover:bg-[#000000] hover:text-[#00f2fe] transition-all border border-white/10"
                >
              ...
              {settings.zaloUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-hover w-10 h-10 rounded-full bg-[#1a1a1a] flex items-center justify-center text-white hover:bg-[#0068FF] transition-all border border-white/10"
                >
        ...
        <div className="max-w-300 w-full mx-auto px-4 py-6">
          <div className="text-center">
            <p className="text-xs text-gray-500">
              ...
              {settings.storeName || "GlowUp Cosmetics"}. All rights reserved.
            </p>
          </div>
        </div>
      </div>
