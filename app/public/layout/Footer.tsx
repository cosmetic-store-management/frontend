        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link to="/" className="inline-flex items-center gap-2.5 group">
              <div
                className="w-9 h-9 rounded-xl overflow-hidden shrink-0 transition-transform duration-300 group-hover:scale-105"
              >
                <img src="/logo.png" alt="GlowUp" className="w-full h-full object-cover scale-[1.4]" />
              </div>
              <span
            ...
            <p className="text-sm leading-relaxed" style={{ color: "hsl(345, 8%, 55%)" }}>
            ...
            <div className="space-y-3">
              {settings.storeAddress && (
                <div className="flex items-start gap-3">
                  <MapPin className="w-4 h-4 shrink-0 mt-0.5" style={{ color: "hsl(352, 72%, 62%)" }} />
                  <span className="text-sm" style={{ color: "hsl(345, 8%, 55%)" }}>
                    {settings.storeAddress}
                  </span>
                </div>
              )}
              {settings.phone && (
                <div className="flex items-center gap-3">
                  <Phone className="w-4 h-4 shrink-0" style={{ color: "hsl(352, 72%, 62%)" }} />
                  <span className="text-sm font-semibold text-white">
                    {settings.phone}{" "}
                    <span className="font-normal" style={{ color: "hsl(345, 8%, 55%)" }}>
                      (8:00–22:00)
                    </span>
                  </span>
                </div>
              ...
              {settings.email && (
                <div className="flex items-center gap-3">
                  <Mail className="w-4 h-4 shrink-0" style={{ color: "hsl(352, 72%, 62%)" }} />
                  <span className="text-sm" style={{ color: "hsl(345, 8%, 55%)" }}>
                    {settings.email}
                  </span>
                </div>
              ...
              {[
                ...
                <li key={label}>
                  <Link
                    ...
                    onMouseLeave={(e) => (e.currentTarget.style.color = "hsl(345, 8%, 55%)")}
                  >
                    {label}
                  </Link>
                </li>
