...
export interface VNProvince { code: number; name: string; }
export interface VNDistrict { code: number; name: string; }
export interface VNWard    { code: number; name: string; }
