...
const DEFAULT_DESC = "Khám phá hàng ngàn sản phẩm mỹ phẩm chính hãng. Skincare, makeup và chăm sóc sắc đẹp với ưu đãi hấp dẫn.";
const DEFAULT_OG   = "/og-image.jpg";

/** Tạo mảng meta objects theo format React Router v7 MetaFunction */
export function buildMeta(opts: SeoMeta) {
  const title = opts.title.includes("|") ? opts.title : `${opts.title} | ${SITE_NAME}`;
