    ...
    <div className="min-h-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-3">
          <h2 className="text-2xl font-bold text-ink tracking-tight">{i18next.t("Đã xảy ra lỗi")}</h2>
          <p className="text-sm text-ink-muted leading-relaxed">{i18next.t(`Trang này gặp sự cố không mong muốn. Vui lòng thử tải lại hoặc liên
