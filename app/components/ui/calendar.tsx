  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday:
          "w-9 text-center text-[0.75rem] font-medium text-ink-muted pb-1",
        week: "flex w-full",
        ...
        today:
          "[&:not([aria-selected='true'])]:bg-surface-muted [&:not([aria-selected='true'])]:text-ink font-semibold rounded-sm",
