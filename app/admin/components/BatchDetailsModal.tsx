    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl">
        <DialogHeader>
          ...
          <div className="text-sm text-ink-muted mt-2 p-3 bg-surface-soft/50 rounded-md border border-border">
            <div className="font-semibold text-ink break-words whitespace-normal leading-relaxed" title={item.name}>
              {item.name}
            </div>
            <div className="text-xs font-mono mt-1 text-ink-muted">
              {item.sku}
            </div>
          </div>
        </DialogHeader>
