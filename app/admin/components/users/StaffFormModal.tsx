...
export function StaffFormModal({
  ...
  return (
    <BaseCrudModal
      ...
      description="Lưu thông tin cá nhân nhân viên. Sau khi lưu, hệ thống sẽ cấp một tài khoản với mật khẩu mặc định là GlowUp@123456."
      size="lg"
      primaryActionText="Xác nhận"
      secondaryActionText="Huỷ"
      onPrimaryAction={handleSubmit(onSubmit as any)}
      isLoading={isLoading}
    >
      <form
