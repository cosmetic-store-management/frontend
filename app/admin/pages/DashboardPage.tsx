        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center bg-surface border border-border rounded-sm shadow-sm overflow-hidden">
            <div className="flex items-center pl-3 border-r border-border bg-surface-soft">
              ...
              <span className="text-xs font-medium text-ink-muted mr-3">
                Từ
              </span>
            </div>
            <Input
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="bg-surface border border-border rounded-sm p-6 shadow-ui-soft transition-all duration-200 hover:shadow-ui-card"
            >
              ...
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="bg-surface-muted text-ink-muted border-b border-border text-left">
                    <th className="pb-3 font-medium text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                      Mã đơn
                    </th>
                    <th className="pb-3 font-medium text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                      Khách hàng
                    ...
                    <th className="pb-3 font-medium text-right text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                      Tổng tiền
                    </th>
                    <th className="pb-3 font-medium text-center text-xs font-semibold uppercase tracking-wide whitespace-nowrap">
                      Trạng thái
                    </th>
                  </tr>
                </thead>
                            ...
                            className={
                              order.status === "Hoàn thành"
                                ...
                                : order.status === "Đang giao"
                                  ? "bg-surface-muted text-ink-muted border-border hover:bg-surface-muted/80"
            ...
            <div className="bg-danger/5 border border-danger/20 rounded-sm p-6 shadow-ui-soft flex flex-col">
              ...
              <div className="space-y-3">
                {data.lowStockItems.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex justify-between items-center bg-surface p-3 rounded-sm border border-danger/10 shadow-sm"
                  >
