...
export function getAdminCategories(
  ...
  return apiClient.get<CategoryListResult>(
...
export function createCategory(
  ...
  return apiClient
    .post<{ category: Category }>("/categories/admin", data)
...
export function updateCategory(
  ...
  return apiClient
    .patch<{ category: Category }>(`/categories/admin/${id}`, data)
    .then((res) => res.category);
}
...
export function updateCategoryStatus(
  ...
  return apiClient
    .patch<{
      category: Category;
    }>(`/categories/admin/${id}/status`, { isActive })
    .then((res) => res.category);
}
